...
class Styles {
  ...
  ThemeData whiteColorTheme(BuildContext context) {
    return ThemeData(
      ...
      scaffoldBackgroundColor: Colored.kWHITE,
      appBarTheme: AppBarTheme(
        iconTheme: const IconThemeData(color: Colored.kWHITE),
...
/*   ThemeData darkColorTheme(BuildContext context) {
    return ThemeData(
      primaryColor: Colors.black, //Colored.kCOLOR_1B262C, //1
      scaffoldBackgroundColor: Colored.kCOLOR_1B262C, //1
      appBarTheme: AppBarTheme(
  ...
  ThemeData replyOrangeColorTheme(BuildContext context) {
    return ThemeData(
      primaryColor: Colored.kCOLOR_4A6572, //1
      scaffoldBackgroundColor: Colored.kWHITE, //5
      appBarTheme: AppBarTheme(
  ...
  ThemeData cranePurpleColorTheme(BuildContext context) {
    return ThemeData(
      ...
      iconTheme: const IconThemeData(color: Colored.kCOLOR_E30425),
    );
  }
